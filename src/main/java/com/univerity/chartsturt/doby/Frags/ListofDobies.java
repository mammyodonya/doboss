 ...
 */
public class ListofDobies extends Fragment {
   ...
   private ListView listView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_listof_dobies, container, false);
    ...
    private void addData() {
        ...
        reference = database.getReference("Dobbies");
